...
-- Design Ports Information
-- OUTPUT	=>  Location: PIN_D5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- A	=>  Location: PIN_C8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- B	=>  Location: PIN_C7,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF OR_USING_NAND IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \NAND3|Y~0_combout\ : std_logic;
...
\NAND3|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \NAND3|Y~0_combout\ = (\A~input_o\) # (\B~input_o\)
