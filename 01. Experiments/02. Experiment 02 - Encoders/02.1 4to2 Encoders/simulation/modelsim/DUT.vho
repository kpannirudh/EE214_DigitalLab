...
-- Design Ports Information
-- input_vector[1]	=>  Location: PIN_121,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[0]	=>  Location: PIN_29,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- output_vector[1]	=>  Location: PIN_27,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[0]	=>  Location: PIN_32,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_30,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[4]	=>  Location: PIN_28,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[3]	=>  Location: PIN_33,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \add_instance|AND2|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[2]~input_o\) # (\input_vector[4]~input_o\)))
...
-- Equation(s):
-- \add_instance|AND1|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[3]~input_o\) # (\input_vector[4]~input_o\)))
