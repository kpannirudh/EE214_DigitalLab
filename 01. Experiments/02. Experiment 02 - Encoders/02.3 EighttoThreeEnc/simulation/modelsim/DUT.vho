...
-- Equation(s):
-- \add_instance|OR2|Y~0_combout\ = (!\input_vector[8]~input_o\ & !\input_vector[4]~input_o\)
...
-- Equation(s):
-- \add_instance|OR2|Y~1_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[2]~input_o\) # ((\input_vector[6]~input_o\) # (!\add_instance|OR2|Y~0_combout\))))
...
PORT MAP (
	...
	datab => \add_instance|OR2|Y~0_combout\,
...
-- Equation(s):
-- \add_instance|OR1|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[7]~input_o\) # ((\input_vector[3]~input_o\) # (!\add_instance|OR2|Y~0_combout\))))
...
-- Equation(s):
-- \add_instance|OR4|Y~0_combout\ = (\input_vector[7]~input_o\) # ((\input_vector[6]~input_o\) # ((\input_vector[8]~input_o\) # (\input_vector[5]~input_o\)))
...
-- Equation(s):
-- \add_instance|OR4|Y~1_combout\ = (\add_instance|OR4|Y~0_combout\ & \input_vector[0]~input_o\)
...
-- pragma translate_on
PORT MAP (
	dataa => \add_instance|OR4|Y~0_combout\,
	datad => \input_vector[0]~input_o\,
