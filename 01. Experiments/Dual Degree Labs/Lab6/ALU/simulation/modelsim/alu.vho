...
-- state_out[3]	=>  Location: PIN_121,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- state_out[4]	=>  Location: PIN_8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|equi~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|equi~1_combout\ : std_logic;
...
-- Equation(s):
-- \shift_reg~2_combout\ = (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & \io~q\))
...
-- Equation(s):
-- \datau[5]~18_combout\ = (\shift_reg~2_combout\ & (\dut_instance|add_instance|Mux0~0_combout\)) # (!\shift_reg~2_combout\ & (((datau(5) & !\shift_reg~1_combout\))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|Mux0~0_combout\,
	datac => datau(5),
...
-- Equation(s):
-- \dut_instance|add_instance|carry~0_combout\ = (dut_input(7) & ((dut_input(6)) # ((dut_input(5) & dut_input(4))))) # (!dut_input(7) & (dut_input(5) & ((dut_input(6)))))
...
-- Equation(s):
-- \dut_instance|add_instance|Mux1~0_combout\ = (dut_input(7) & (!\dut_instance|add_instance|carry~0_combout\ & !dut_input(3)))
...
-- Equation(s):
-- \datau[3]~14_combout\ = (dut_input(5) & (dut_input(4) & !dut_input(6))) # (!dut_input(5) & ((dut_input(6))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~0_combout\ = (dut_input(5) & (!dut_input(4) & (dut_input(1) & dut_input(0)))) # (!dut_input(5) & ((dut_input(1)) # ((!dut_input(4) & dut_input(0)))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~1_combout\ = (\dut_instance|add_instance|LessThan1~0_combout\ & ((dut_input(2)) # (!dut_input(6)))) # (!\dut_instance|add_instance|LessThan1~0_combout\ & (dut_input(2) & !dut_input(6)))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan1~2_combout\ = (\dut_instance|add_instance|LessThan1~1_combout\ & (dut_input(7) $ (!dut_input(3))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan0~0_combout\ = (dut_input(7) & (((!dut_input(2) & dut_input(6))) # (!dut_input(3)))) # (!dut_input(7) & (!dut_input(2) & (!dut_input(3) & dut_input(6))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan0~1_combout\ = (dut_input(1) & (dut_input(4) & (dut_input(5) & !dut_input(0)))) # (!dut_input(1) & ((dut_input(5)) # ((dut_input(4) & !dut_input(0)))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan0~2_combout\ = (dut_input(7) & (dut_input(3) & (dut_input(2) $ (!dut_input(6))))) # (!dut_input(7) & (!dut_input(3) & (dut_input(2) $ (!dut_input(6)))))
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|LessThan0~2_combout\,
	combout => \dut_instance|add_instance|LessThan0~3_combout\);

-- Location: LCCOMB_X28_Y21_N6
\dut_instance|add_instance|equi~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|equi~0_combout\ = (dut_input(4) & (dut_input(0) & (dut_input(1) $ (!dut_input(5))))) # (!dut_input(4) & (!dut_input(0) & (dut_input(1) $ (!dut_input(5)))))
...
PORT MAP (
	...
	datac => dut_input(0),
	datad => dut_input(5),
	combout => \dut_instance|add_instance|equi~0_combout\);

-- Location: LCCOMB_X29_Y21_N18
\dut_instance|add_instance|equi~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|equi~1_combout\ = (\dut_instance|add_instance|equi~0_combout\ & \dut_instance|add_instance|LessThan0~2_combout\)
...
-- pragma translate_on
PORT MAP (
	datac => \dut_instance|add_instance|equi~0_combout\,
	datad => \dut_instance|add_instance|LessThan0~2_combout\,
	combout => \dut_instance|add_instance|equi~1_combout\);

-- Location: LCCOMB_X28_Y21_N8
\datau[1]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[1]~4_combout\ = (dut_input(3) & (((dut_input(7) & !\dut_instance|add_instance|equi~1_combout\)))) # (!dut_input(3) & (((dut_input(7))) # (!\dut_instance|add_instance|LessThan0~3_combout\)))
...
PORT MAP (
	...
	datab => dut_input(3),
	datac => dut_input(7),
	datad => \dut_instance|add_instance|equi~1_combout\,
...
PORT MAP (
	dataa => dut_input(7),
	datab => dut_input(3),
	datad => \dut_instance|add_instance|LessThan0~3_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|LessThan1~2_combout\,
	datab => \datau[1]~4_combout\,
...
-- Equation(s):
-- \datau[3]~16_combout\ = (dut_input(3) & ((\datau[3]~15_combout\ & ((\datau[1]~6_combout\) # (\dut_instance|add_instance|equi~1_combout\))) # (!\datau[3]~15_combout\ & (!\datau[1]~6_combout\)))) # (!dut_input(3) & (\datau[3]~15_combout\ & 
-- (!\datau[1]~6_combout\)))
...
-- Equation(s):
-- \datau[2]~11_combout\ = (\datau[1]~4_combout\ & (((\datau[2]~10_combout\ & \datau[1]~3_combout\)))) # (!\datau[1]~4_combout\ & ((dut_input(6)) # ((!\datau[1]~3_combout\))))
...
-- Equation(s):
-- \dut_instance|add_instance|Mux5~0_combout\ = (dut_input(3) & (((!dut_input(7)) # (!\dut_instance|add_instance|equi~0_combout\)) # (!\dut_instance|add_instance|LessThan0~2_combout\)))
...
PORT MAP (
	dataa => \dut_instance|add_instance|LessThan0~3_combout\,
	datab => \dut_instance|add_instance|Mux5~0_combout\,
	datad => dut_input(7),
...
PORT MAP (
	...
	datab => dut_input(4),
	datac => \dut_instance|add_instance|Mux5~2_combout\,
	datad => \dut_instance|add_instance|Mux5~0_combout\,
...
-- Equation(s):
-- \dut_instance|add_instance|Mux0~0_combout\ = (dut_input(7) & (\dut_instance|add_instance|carry~0_combout\ & !dut_input(3)))
