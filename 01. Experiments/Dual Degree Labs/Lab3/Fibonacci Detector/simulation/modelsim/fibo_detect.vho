...
SIGNAL \add_instance|OR1|Y~combout\ : std_logic;
...
\add_instance|OR1|Y\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR1|Y~combout\ = (\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & ((!\input_vector[1]~input_o\)))) # (!\input_vector[2]~input_o\ & (((!\input_vector[0]~input_o\ & !\input_vector[1]~input_o\)) # (!\input_vector[3]~input_o\)))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0000010110011101",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	...
	combout => \add_instance|OR1|Y~combout\);
