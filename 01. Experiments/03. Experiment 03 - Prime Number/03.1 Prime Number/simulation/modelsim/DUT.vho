...
-- DATE "08/18/2022 16:27:12"

-- 
-- Device: Altera 10M25SAE144A7G Package EQFP144
-- 
...
SIGNAL \add_instance|OR1|O~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR1|O~0_combout\,
	devoe => ww_devoe,
...
\add_instance|OR1|O~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR1|O~0_combout\ = (\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & ((!\input_vector[1]~input_o\) # (!\input_vector[3]~input_o\)))) # (!\input_vector[2]~input_o\ & (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # 
...
PORT MAP (
	...
	combout => \add_instance|OR1|O~0_combout\);
