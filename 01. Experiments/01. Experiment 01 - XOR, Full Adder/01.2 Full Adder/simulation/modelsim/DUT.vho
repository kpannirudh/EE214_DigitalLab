...
-- input_vector[2]	=>  Location: PIN_57,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|HA_2|NAND6|Y~0_combout\ : std_logic;
SIGNAL \add_instance|OR_1|NAND3|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|HA_2|NAND6|Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR_1|NAND3|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|HA_2|NAND6|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|HA_2|NAND6|Y~0_combout\ = \input_vector[1]~input_o\ $ (\input_vector[0]~input_o\ $ (\input_vector[2]~input_o\))
...
PORT MAP (
	...
	combout => \add_instance|HA_2|NAND6|Y~0_combout\);

-- Location: LCCOMB_X20_Y1_N26
\add_instance|OR_1|NAND3|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR_1|NAND3|Y~0_combout\ = (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # (\input_vector[2]~input_o\))) # (!\input_vector[1]~input_o\ & (\input_vector[0]~input_o\ & \input_vector[2]~input_o\))
...
PORT MAP (
	...
	datab => \input_vector[0]~input_o\,
	datad => \input_vector[2]~input_o\,
	combout => \add_instance|OR_1|NAND3|Y~0_combout\);
